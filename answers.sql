...
SELECT givenname, surname, email
FROM salespeople
...
SELECT email, givenname, surname FROM Salespeople
...
SELECT melon_type, common_name, price, (price * .735693) AS euros
FROM melons;
